...
#include "AudiokineticTools/Classes/Platforms/AkPlatform_Windows/AkWindowsPlatformInfo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	AUDIOKINETICTOOLS_API UClass* Z_Construct_UClass_UAkWin32PlatformInfo_NoRegister();
	AUDIOKINETICTOOLS_API UClass* Z_Construct_UClass_UAkWin32PlatformInfo();
	AUDIOKINETICTOOLS_API UClass* Z_Construct_UClass_UAkPlatformInfo();
	UPackage* Z_Construct_UPackage__Script_AudiokineticTools();
	AUDIOKINETICTOOLS_API UClass* Z_Construct_UClass_UAkWin64PlatformInfo_NoRegister();
	AUDIOKINETICTOOLS_API UClass* Z_Construct_UClass_UAkWin64PlatformInfo();
	AUDIOKINETICTOOLS_API UClass* Z_Construct_UClass_UAkWindowsPlatformInfo_NoRegister();
	AUDIOKINETICTOOLS_API UClass* Z_Construct_UClass_UAkWindowsPlatformInfo();
// End Cross Module References
	...
	IMPLEMENT_CLASS(UAkWin32PlatformInfo, 734561426);
	template<> AUDIOKINETICTOOLS_API UClass* StaticClass<UAkWin32PlatformInfo>()
	{
		return UAkWin32PlatformInfo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAkWin32PlatformInfo(Z_Construct_UClass_UAkWin32PlatformInfo, &UAkWin32PlatformInfo::StaticClass, TEXT("/Script/AudiokineticTools"), TEXT("UAkWin32PlatformInfo"), false, nullptr, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UAkWin64PlatformInfo, 1494621644);
	template<> AUDIOKINETICTOOLS_API UClass* StaticClass<UAkWin64PlatformInfo>()
	{
		return UAkWin64PlatformInfo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAkWin64PlatformInfo(Z_Construct_UClass_UAkWin64PlatformInfo, &UAkWin64PlatformInfo::StaticClass, TEXT("/Script/AudiokineticTools"), TEXT("UAkWin64PlatformInfo"), false, nullptr, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UAkWindowsPlatformInfo, 3174161540);
	template<> AUDIOKINETICTOOLS_API UClass* StaticClass<UAkWindowsPlatformInfo>()
	{
		return UAkWindowsPlatformInfo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAkWindowsPlatformInfo(Z_Construct_UClass_UAkWindowsPlatformInfo, &UAkWindowsPlatformInfo::StaticClass, TEXT("/Script/AudiokineticTools"), TEXT("UAkWindowsPlatformInfo"), false, nullptr, nullptr, nullptr);
